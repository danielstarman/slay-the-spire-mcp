...
import spirebridge.patches.UpdateBodyTextPatch;
...
public class GameStateConverter {
    ...
    /**
     * Creates a JSON representation of the status of SpireBridge that will be sent to the external process.
     ...
     * @return A string containing the JSON representation of SpireBridge's status
     */
